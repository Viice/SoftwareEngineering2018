...
public class MapBuilder {
	...
	private void buildRoads() {
		// Why is "western highway" in the east?
		...
		roads.put("EastWestUsed", new Road(new Point(415, 200), new Point(785, 200), Direction.EAST, true, true));
	}
	...
	private void buildTracks() {
		...
		tracks.put("West", new RailwayTracks(new Point(0, 550), new Point(1200, 550)));
	}

	private void assignGatesToRoads() {
		// Pass the road to the car factory for reference.
