...
public class CrossingGate extends Observable implements Observer {
	...
	public void update(Observable o, Object arg) {
		if (o instanceof Train) {
			Train train = (Train) o;
			// Since there are two trains, if the train or the train's partner is within the
			// closing range, close the gate.
			if (train.getVehicleX() < triggerPoint && train.getVehicleX() > exitPoint
					|| train.getPartner().getVehicleX() < triggerPoint && train.getPartner().getVehicleX() > exitPoint)
